...
public class GamePanel extends JPanel implements Runnable{
    ...
    private final BufferedImage wallImg = Helper.loadImg("resources/Wall1.gif");
...
//    }
    ...
    public void run(){
        ...
        //create player 2
        BufferedImage t2img = Helper.loadImg("resources/Tank2.gif");
        players.add(new Player(1000, 200, 0, 0, 0, t2img));
            ...
            for (int k = 0; k < players.size(); k++) {
                ...
                if (PBdist <= (b.getr() + p.getr()) && b.getShotBy() != p.getPlayerIndex()) {
                    ...
                    if (p.isDead()) {
                        ...
                        p.setX(originSpawnPosX*Math.random());
                        p.setY(originSpawnPosy*Math.random());
